...
module.exports = {
  SHARED_PASSWORD,
  CANDIDATE: {
    email: process.env.QA_CANDIDATE_EMAIL || 'qa-candidate@matchhire.test',
    password: SHARED_PASSWORD,
    full_name: 'QA Candidate',
    role: 'candidate',
  },
  COMPANY: {
    email: process.env.QA_COMPANY_EMAIL || 'qa-company@matchhire.test',
    password: SHARED_PASSWORD,
  ...
  ADMIN: {
    email: process.env.QA_ADMIN_EMAIL || 'qa-admin@matchhire.test',
    password: SHARED_PASSWORD,
    full_name: 'QA Admin',
    role: 'admin',
  },
